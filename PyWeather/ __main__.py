...
from PyWeather.core import load_parsers
from PyWeather.core import ForecastType
from PyWeather.core import Unit
from PyWeather.core import CustomUnitAction
...
parsers = load_parsers.load('./PyWeather/parsers')
...
required = False,
dest = 'unit',
help = ('Specify what unit you want to display the temperatures in'),)


required.add_argument('-a', '--areacode',
required=True,
dest='area_code',
help=('The code area to get the weather broadcast from Weather. It can be obtained at https://weather.com'))
